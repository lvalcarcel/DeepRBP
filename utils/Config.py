class Config(): 
    ...
    def __init__(self,
        ...
        Args:
            ...
            modelNN(string): The type of neural network model being used, for example, DeepRBP.
            if_wandb (bool): All parameters are tracked by weights and biases. Defaults to False.
